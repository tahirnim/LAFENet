...
from nets.CFFANet import CFFANet
...
if __name__ == '__main__':
    ...
    elif config.task_name is "InstrumentsSeg_p6":
        test_num = 118
        model_type = config.model_name
        model_path = "./InstrumentsSeg_p6/"+model_type+"/"+test_session+"/models/best_model-"+model_type+".pth.tar"
    ...
    elif config.task_name is "TNK3_augmented":
        test_num = 614
        model_type = config.model_name
        model_path = "./TNK3/"+model_type+"/"+test_session+"/models/best_model-"+model_type+".pth.tar"
