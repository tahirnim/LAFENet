...
from nets.DenseCFFANet import DCFFANet

from nets.proposed_model_2 import proposed_model_2
from nets.MAResUNet import MAResUNet
...
def main_loop(batch_size=config.batch_size, model_type='', tensorboard=True):
    ...
    elif model_type == 'CFFANet_1':
        logger.info('Training on CFFANet')
        model = CFFANet_1()

    elif model_type == 'CFFANet_2':
        logger.info('Training on CFFANet_2')
        model = CFFANet_2()

    elif model_type == 'DCFFANet':
        logger.info('Training on DCFFANet')
        model = DCFFANet()

    elif model_type == 'MAResUNet':
        logger.info('Training on MAResUNet')
        model = MAResUNet()
...
# Readme information
# random seed and set cudnn as 'deterministic' mode to eliminate the randomness.